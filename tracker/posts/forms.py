...
class CreateArticle(forms.ModelForm):
    ...
    Start_Time = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'HH:MM','title':'Mention the start time in 24 hour time formant','style': 'width: 55% !important; resize: vertical !important;'}))

    #placeholder="HH:MM" size="13" title="Enter the time you spent" pattern=".+:.+"/
    Responded_Time = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'HH:MM','title':'Mention the Responded time in 24 hour time formant','style': 'width: 55% !important; resize: vertical !important;'}))

    Time_spent = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'HH:MM','title':'Mention the Total time spent in 24 hour time formant','style': 'width: 55% !important; resize: vertical !important;'}))
    MONTH_CHOICES = (
    ('January', 'January'),
    ('February', 'February'),
    ('March', 'March'),
