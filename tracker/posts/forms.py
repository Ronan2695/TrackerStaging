...
class CreateArticle(forms.ModelForm):
    ...
    shift_choices=(('apac','APAC'),('apac','EMEA'),('apac','USA'))
    ...
    Day_Of_Week = forms.ChoiceField(choices=Day_Of_Week, widget=forms.RadioSelect, initial='wd')
    ...
    prior=(('p0','P0'),('p1','P1'),('p2','P2'),('no','None'))
